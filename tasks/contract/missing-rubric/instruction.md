...
Read `/app/Routing_Request.json`. The public contract is available through `harness-stub describe` if needed. Check only its documented rubric path through `harness-stub lookup-rubric 'JSON_OBJECT'`.
