...
Read `/app/Execution_Request.json`. The public contract is available through `harness-stub describe` if needed. Check its exact required executor through `harness-stub capability-check 'JSON_OBJECT'`.
